...
// Admin routes
router.post('/admin', protect, handleUploadError, createSlider);
router.put('/admin/:id', protect, handleUploadError, updateSlider);
router.delete('/admin/:id', protect, deleteSlider);
